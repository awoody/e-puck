...
.equ PLLMode, 1						;PLL multiplier
.equ baud, 19200					; desired baud rate
...
_init_uart1:
	...
	bset PMD1bits, #0 	;disbale adc module - it conflicts with the UART by default
	mov	#0x8000, W0		;bit15=UARTEN,  bit10=ALTIO
	mov	W0, U1MODE
	mov	#0x0400, W0		;bit10=UTXEN
	mov	W0, U1STA
    mov #BRGH, W0  		;?Initialize Baud rate (divide INSTRUCTION Cycle)
    mov w0, U1BRG      
